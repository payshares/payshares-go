...
import (
	...
	"github.com/payshares/go/handlers/federation"
...
func main() {
	rootCmd := &cobra.Command{
		Use:   "federation",
		Short: "payshares federation server",
		Long: `
The payshares federation server let's you easily integrate the payshares federation 
