...
// structures used by the payshares network, most importanly transactions.
//
...
var (
	...
	// to the main public payshares network.
	...
	// to the test payshares network (often called testnet).
	TestNetwork = Network{network.TestNetworkPassphrase}

	// DefaultNetwork is a mutator that configures the
	// transaction for submission to the default payshares
...
// Network establishes the payshares network that a transaction should apply to.
