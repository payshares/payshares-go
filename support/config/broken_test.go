...
func TestOptionalPaysharesFields(t *testing.T) {
	var val struct {
		F1 string `valid:"payshares_accountid,optional"`
		F2 string `valid:"optional,payshares_accountid"`
		F3 string `valid:"payshares_seed,optional"`
		F4 string `valid:"optional,payshares_accountid"`
	}
